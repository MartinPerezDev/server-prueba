[
  ...
  {
    "id": 3,
    "name": "Auriculares Redragon Cybill H312",
    "description": "Robustos, cómodos y con una calidad de sonido impactante; los Cybill son audífonos USB diseñados para que puedas disfrutar de una experiencia 360° en tus juegos favoritos.",
    "stock": 8,
    "image": "/image/Cybill.png",
    "price": 450,
    "category": "auriculares"
  },
  {
  ...
  {
    "id": 6,
    "name": "Mouse King Pro M916",
    "description": "100% enfocado en el rendimiento, el K1ng Pro es nuestro ratón tope de gama para los jugadores más competitivos.",
    "stock": 8,
    "image": "/image/KING-PRO-1K-BLACK-M916.png",
    "price": 450,
    "category": "mouse"
  },
  {
  ...
  {
    "id": 8,
    "name": "Microfono Blazar GM300",
    "description": "El Blazar es un micrófono de condensador optimizado para streaming, con características idóneas para la captura y la grabación o la transmisión en vivo y un diseño cómodo, altamente funcional, que luce muy bien en cámara. Elevará perceptiblemente la calidad de tus transmisiones.",
    "stock": 8,
    "image": "/image/BLAZAR.png",
    "price": 450,
    "category": "streaming"
  },
  {
